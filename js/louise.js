...
function generateLouiseCopypasta(louise) {
	return `${louise}！${louise}！${louise}！${louise}ぅぅうううわぁああああああああああああああああああああああん！！！
あぁああああ…ああ…あっあっー！あぁああああああ！！！${louise}${louise}${louise}ぅううぁわぁああああ！！！
...
function handleSubmit(_) {
	copypasta.value = generateLouiseCopypasta(louise_name.value);
}
